...
The plugin defaults to installing and updating the 'GeoLite Country' database,
but if you wish to use another available database or if you're a GeoIP licensee,
you can set some configuration options via the +configure+ method or
<tt>moonshine.yml</tt>:
...
Apache +mod_geoip+ module exactly how you want them:
